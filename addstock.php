...
.container{
  ...
  <body>
    ...
    <hr><br>
    <div class="container">
        <form action="stockaddorderdata.php" method="POST">
            <div class="form-group">
                <label for="">กรอกสินค้าที่ต้องการ</label>
           
                <input type="text" class="form-control" name="nameaddstock" required>
            </div><br>
    
            <div class="form-group">
                <label>ราคาสินค้าต่อชิ้น</label>
                <input type="text" class="form-control" name="pricetoorder" required>
            </div><br>
            <button type="submit" class="btn btn-success">เพิ่มสินค้า</button>
            <a href="stockbuyorder.php" class="btn btn-danger">กลับไปหน้าสั่งซื้อสินค้า</a>
        </form>
